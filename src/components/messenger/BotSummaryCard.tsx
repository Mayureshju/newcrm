  ...
  return (
    <div className="flex items-start justify-end gap-2 pt-2">
      <div className="flex max-w-[70%] flex-col items-end gap-1">
        <span className="pr-1 text-[11.5px] font-medium text-gray-600">Bot</span>
        <div className="rounded-2xl rounded-tr-md bg-rose-100/80 px-4 py-3 text-[13px] leading-relaxed text-gray-800">
        ...
        <span className="pr-1 text-[11px] text-gray-400">
          {summary.timeLabel}
        </span>
      </div>
