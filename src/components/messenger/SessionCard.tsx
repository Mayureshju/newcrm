...
export function SessionCard({
  ...
  return (
    <section className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-theme-xs transition">
      <header className="flex items-start justify-between gap-3 px-5 py-4">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="inline-flex items-center rounded-md bg-gray-100 px-1.5 py-0.5 text-[10.5px] font-medium text-gray-600">
                {meta.label}
              </span>
            </div>
        ...
        <div className="flex shrink-0 flex-col items-end gap-2">
          ...
          {session.closedByEmail && (
            <p className="max-w-[220px] truncate text-[12px] text-gray-500">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              className="inline-flex size-7 items-center justify-center rounded-md text-gray-500 transition hover:bg-gray-100"
            >
              <Icon
                name="chevron-down"
