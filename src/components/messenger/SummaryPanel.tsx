...
export function SummaryPanel({
  ...
  return (
    <aside className="hidden w-80 shrink-0 flex-col border-l border-gray-200 xl:flex">
      <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
        <h3 className="text-[14px] font-semibold text-gray-800">Summary</h3>
        ...
        >
          ...
          <div className="mt-2 space-y-2">
            <label className="block">
              ...
              <div className="flex items-center gap-2 rounded-md border border-gray-200 bg-white px-3 py-2 text-[13px] text-gray-800">
            ...
            <button
              type="button"
              className="mt-2 w-full rounded-md bg-gray-900 px-3 py-2 text-[12.5px] font-medium text-white transition hover:bg-gray-800"
            >
              Manage
            </button>
          </div>
          ...
          <div className="space-y-3 py-1">
            <label className="block">
              ...
              <textarea
                ...
                rows={3}
                placeholder="Summary"
                className="block w-full resize-none rounded-md border border-gray-200 bg-white px-3 py-2 text-[13px] text-gray-800 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10"
              />
            </label>
            ...
            <label className="block">
              ...
              <div className="relative">
                <select
                  ...
                  className="h-9 w-full appearance-none rounded-md border border-gray-200 bg-white px-3 pr-8 text-[13px] text-gray-700 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10"
                >
            ...
            <button
              type="button"
              onClick={onUpdate}
              className="mt-1 w-full rounded-md bg-gray-900 px-3 py-2 text-[12.5px] font-medium text-white transition hover:bg-gray-800"
            >
              Update
            </button>
          </div>
