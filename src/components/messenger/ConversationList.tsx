      ...
      <div className="flex flex-col gap-3 border-b border-gray-200 px-4 pb-3 pt-4 dark:border-gray-800">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2">
            <h2 className="text-[17px] font-semibold text-gray-800 dark:text-white/90">Messages</h2>
        ...
        <div className="flex items-center justify-between gap-2">
          <label className="relative inline-flex">
            ...
            <select
              ...
              className="h-8 appearance-none rounded-md border border-gray-200 bg-white pl-2.5 pr-7 text-[12px] text-gray-700 focus:border-brand-500 focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
            >
          ...
          <button
            type="button"
            className="inline-flex h-8 items-center gap-1.5 rounded-md border border-gray-200 bg-white px-2.5 text-[12px] font-medium text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
          >
        ...
        <label className="relative block">
          ...
          <input
            ...
            placeholder="Search"
            className="h-9 w-full rounded-md bg-gray-50 pl-9 pr-3 text-[13px] text-gray-700 placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-4 focus:ring-brand-500/10 dark:bg-gray-800 dark:text-gray-200 dark:placeholder:text-gray-500 dark:focus:bg-gray-800"
          />
        </label>
      </div>
      <div className="no-scrollbar flex items-center gap-3 overflow-x-auto border-b border-gray-200 px-4 dark:border-gray-800">
        {FILTER_TABS.map((tab) => {
          ...
          return (
            ...
            >
              {tab.label}
              <span className={active ? "ml-0.5" : "ml-0.5 text-gray-400 dark:text-gray-500"}>
                ({tab.count})
              </span>
              {active && (
